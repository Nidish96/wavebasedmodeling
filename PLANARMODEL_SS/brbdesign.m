...
%% Nodal displacements (and rotations) at interface
...
save('./DATS/BRBMATS.mat', 'Mbrb', 'Kbrb', 'Kbolt', 'Mbolt', 'Fbolt', 'Qrel', ...
            ...
            'Q2', 'T2', 'BoltLocs', 'Lmono', 'Lint', 'nu', 'Xqps', 'Fboltd');

% Fixed Interface
Lfix = null(Ri1*L1 - Ri2*L2);
...
text(BM1.X-wdt/4, BM1.Y-wdt/8, num2str((1:Nemono+1)'))
text(IN1.X-wdt/4, IN1.Y-wdt/8, num2str((Nemono+1+(1:Nein+1))'))

text(IN2.X+wdt/8, IN2.Y+wdt/8, num2str((Nemono+Nein+2)+(1:Nein+1)'))
text(BM2.X+wdt/8, BM2.Y+wdt/8, num2str((Nemono+2*Nein+3)+(1:Nemono+1)'))